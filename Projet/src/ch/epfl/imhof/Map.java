...
/**
 * Une carte composee de polylignes et de polygones
 * 
...
public final class Map {
	...
	/**
	 * Construit une carte a partir des listes de polylignes et de polygones accompagnes d'eventuels attributs
	 * 
	 * @param polyLines
	...
	public static final class Builder {
		...
		/**
		 * Ajoute un nouveau Attributed<PolyLine> a la liste
		 * 
		 * @param newPolyLine
		 * 				Le Attributed<PolyLine> a ajouter
		 */
		...
		/**
		 * Ajoute un nouveau Attributed<Polygon> a la liste
		 * 
		 * @param newPolyLine
		 * 				Le Attributed<Polygon> a ajouter
		 */
		...
		/**
		 * Construit une nouvelle Map a partir des listes du builder
		 * 
		 * @return
		 * 				Une nouvelle Map construite a partir des listes du builder
		 */
		public Map build() {
