...
/**
 * Un convertisseur d'entites OSM en entites geometriques
 * 
...
public final class OSMToGeoTransformer {
	...
	/**
	 * Transforme une OSMMap en une Map composee d'entites geometriques
	 * 
	 * @param map
	 * 			La OSMMap a transformer
	 * @return
	 * 			La Map contenant les polylignes construites a partir des OSMEntity de l'OSMMap
	 */
	public Map transform(OSMMap map) {
		 ...
		 * ouvertes ou fermees selon si ces OSMWay decrivent des surfaces ou
		 * non.
		 */
		...
		/*
		 * Convertit chaque OSMRelation en lot de polygones si elle decrit un
	...
	/**
	 * Construit des polylignes correspondant aux membres (au rôle donne en argument) de la relation donnee en argument
	 * 
	 * @param relation
	 * 				La relation dont les donnees sont extraites
	 * @param role
	 * 				Le rôle des elements recherches
	 * @return
	...
	private List<ClosedPolyLine> ringsForRole(OSMRelation relation, String role) {
		 ...
		 * et les place dans un graphe non-oriente, lies a leur voisins comme
		 * ils l'etaient dans leurs OSMWay respectives.
		 */
		...
		/*
		 * Construit des polylignes a partir des points du graphe non-oriente.
	...
	/**
	 * Retourne une liste de Attributed<Polygon> construits a partir des listes polylignes extraites de la relation, avec les attributs donnees en argument
	 * 
	 * @param relation
	 * 				La relation dont les donnees sont extraites
	 * @param attributes
	 * 				Les attributs a associer a chaque polygone
	 * @return
	...
	public List<Attributed<Polygon>> assemblePolygon(OSMRelation relation, Attributes attributes) {
		...
		/*
		 * Parcourt les polylignes externes de la plus petite a la plus grande
		 * et associe a la polyligne courante toutes les polylignes internes
		 * pas encore assignees se trouvant a l'interieur de cette derniere.
		 */
