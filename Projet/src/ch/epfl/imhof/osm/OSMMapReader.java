...
public final class OSMMapReader {
	...
	/**
	 * Retourne le fichier donc le nom est passe en argument et le decompresse si le parametre unGZip vaut true
	 * 
	 * @param fileName
	 * 				Le nom du fichier
	 * @param unGZip
	 * 				Le parametre determinant s'il faut decompresser le fichier
	 * @return
	 * 				Le fichier decompresse
	 * @throws IOException
	...
	/**
	 * Retourne une OSMMap construite a partir du fichier XML passe en parametre
	 * 
	 * @param fileName
	 * 				Le nom du fichier
	 * @param unGZip
	 * 				Le parametre determinant s'il faut decompresser le fichier
	 * @return
	 * 				Une OSMMap construite a partir des instructions du fichier XML dont le nom est passe en parametre
	 * @throws SAXException
		...
		r.setContentHandler(new DefaultHandler() {
			...
			public void startElement(String uri, String lName, String qName, Attributes atts) throws SAXException {
				...
				case MEMBER:
					...
					if (member == null)
					    currentRelation.setIncomplete();
					else
					    currentRelation.addMember(Member.Type.valueOf(atts.getValue(TYPE).toUpperCase()), atts.getValue(ROLE), member);
					break;
			...
			public void endElement(String uri, String lName, String qName) {
				switch (qName) {
				case NODE :
					if (!currentNode.isIncomplete())
					    builder.addNode(currentNode.build());
					break;
				case WAY : 
					if (!currentWay.isIncomplete()) 
					    builder.addWay(currentWay.build());
					break;
				case RELATION : 
					if (!currentRelation.isIncomplete())
					    builder.addRelation(currentRelation.build());
					break;
				}
			}
		});
