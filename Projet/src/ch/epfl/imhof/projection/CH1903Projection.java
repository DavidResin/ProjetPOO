...
/**
 * La projection CH1903 dans les deux sens (sphere -> plan & plan -> sphere dans cet ordre)
 *
...
public final class CH1903Projection implements Projection {
	...
	public Point project(PointGeo point) {
		final double l = (Math.toDegrees(point.longitude()) * 3600 - 26782.5) / 10000d;
		final double p = (Math.toDegrees(point.latitude()) * 3600 - 169028.66) / 10000d;
	...
	public PointGeo inverse(Point point) {
		final double x = (point.x() - 600000) / 1000000d;
		final double y = (point.y() - 200000) / 1000000d;
		...
		return new PointGeo(Math.toRadians(l * 25 / 9d), Math.toRadians(p * 25 / 9d));
	}
}
