...
/**
 * Un modele digital d'elevation traitant les fichiers HGT
 * 
...
public class HGTDigitalElevationModel implements DigitalElevationModel {
    ...
    /**
     * Construit le modele d'elevation a partir d'un fichier HGT
     * 
     * @param file
     *              Le fichier HGT a traiter
     * @throws IllegalArgumentException
     *              Si le nom du fichier ne suit pas le modele {N,S} + {0-9}x2 + {E,W} + {0-9}x3 + ".hgt", ou si son nombre d'elements n'est pas un carre impair
     * @throws IOException
    ...
    public Vector3 normalAt(PointGeo p) throws IllegalArgumentException {
        ...
        return new Vector3(s * (z0 - z1 + z2 - z3) / 2d, s * (z0 + z1 - z2 - z3) / 2d, Math.pow(s, 2));
    }
