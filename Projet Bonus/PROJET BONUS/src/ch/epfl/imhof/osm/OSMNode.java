...
/**
 * Un noeud OpenStreetMap qui hérite de OSMEntity, avec en plus une position fixe définie par un PointGeo
 * 
...
public final class OSMNode extends OSMEntity {
	 ...
	 * @param position
	 * 				La position du noeud en coordonnées sphériques
	 * @param attributes
