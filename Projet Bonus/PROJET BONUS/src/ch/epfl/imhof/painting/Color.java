...
/**
 * Une couleur définie par ses composantes rouge, verte et bleue.
 * 
...
public final class Color {
	...
	/**
	 * Construit une couleur à partir des valeurs de rouge, vert et bleu passés en argument
	 * 
	 * @param red
	 *                 Le niveau de rouge
	 * @param green
	...
	/**
	 * Construit une couleur à partir des niveaux de couleurs de base passés en argument
	 * 
	 * @param r
	 *                 Le niveau de rouge
	 * @param g
	...
	/**
	 * Construit une couleur à partir du int passé en argument après l'avoir décomposé en trois octets contenant les valeurs du rouge, du vert et du bleu
	 * 
	 * @param color
	...
	/**
	 * Mélange this avec la couleur passée en argument
	 * 
	 * @param c
	 *                 La couleur à mélanger avce this
	 * @return
	 *                 Une nouvelle couleur résultant du mélange
	 */
